...
hl.bind("XF86AudioMute",         hl.dsp.exec_cmd("pactl set-sink-mute alsa_output.pci-0000_00_1f.3.analog-stereo toggle"), { repeating = true })
hl.bind("XF86AudioMicMute",      hl.dsp.exec_cmd("pactl set-source-mute alsa_input.pci-0000_00_1f.3.analog-stereo toggle"), { repeating = true })
hl.bind("XF86Bluetooth",         hl.dsp.exec_cmd("echo \"power on\\nconnect CC:98:8B:93:3A:17\" | bluetoothctl && pactl -- set-sink-volume bluez_sink.CC_98_8B_93_3A_17.a2dp_sink 100%"), { repeating = true })
...
hl.bind("XF86PowerOff",          hl.dsp.exec_cmd("power-menu"), { repeating = true })
