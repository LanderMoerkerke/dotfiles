...
c.bindings.commands = {
    "normal": {
        ...
        "<Ctrl-d>": "config-cycle content.user_stylesheets styles/dark-global.css ''",
        ...
        "sb": "spawn --userscript ~/Pipenv/packages/qutebrowser/misc/userscripts/getbib",
        "sc": "spawn --userscript ~/Pipenv/packages/qutebrowser/misc/userscripts/cast",
        "sj": "spawn --userscript ~/Pipenv/packages/qutebrowser/misc/userscripts/format_json stata-dark",
        "sm": "spawn --userscript ~/Pipenv/packages/qutebrowser/misc/userscriptsview_in_mpv",
